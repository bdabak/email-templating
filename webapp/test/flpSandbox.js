		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comthyuxemailtemplate-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comthyuxemailtemplate-display": {
								"semanticObject": "comthyuxemailtemplate",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.thy.ux.emailtemplate",
									"url": sap.ui.require.toUrl("com/thy/ux/emailtemplate")
								}
							}
						}
					}
