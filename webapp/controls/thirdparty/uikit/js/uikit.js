  ...
  if (
    ...
    (i.Utils.isInView = function (e, n) {
      ...
      var s = i.$win.scrollLeft(),
        ...
        c = r.top;
      return (
        (n = t.extend({ topoffset: 0, leftoffset: 0 }, n)),
        c + o.height() >= a &&
        c - n.topoffset <= a + i.$win.height() &&
        l + o.width() >= s &&
        l - n.leftoffset <= s + i.$win.width()
          ? !0
          : !1
      );
    }),
    ...
    (i.component.boot = function (t) {
      i.components[t].prototype &&
        i.components[t].prototype.boot &&
        !i.components[t].booted &&
        (i.components[t].prototype.boot.apply(i, []),
    ...
    (i.on = function (t, e, n) {
      return (
        t && t.indexOf("ready.uk.dom") > -1 && i.domready && e.apply(i.$doc),
        i.$doc.on(t, e, n)
      );
    }),
    (i.one = function (t, e, n) {
      return t && t.indexOf("ready.uk.dom") > -1 && i.domready
        ? (e.apply(i.$doc), i.$doc)
        : i.$doc.one(t, e, n);
    }),
                ...
                n = function () {
                  ...
                  (t.x != o || t.y != s) &&
                    ...
                    i.$doc.trigger("scrolling.uk.document", [
                      { dir: { x: t.dir.x, y: t.dir.y }, x: o, y: s },
                    ])),
        ...
        "MSGesture" in window &&
          ...
          t(document)
            .on("MSGestureEnd gestureend", function (t) {
              ...
              i &&
                void 0 !== d.el &&
                (d.el.trigger("swipe"), d.el.trigger("swipe" + i));
            })
            .on("touchstart MSPointerDown pointerdown", function (i) {
              ("MSPointerDown" != i.type || s(i.originalEvent)) &&
                ...
                (v = g - (d.last || g)),
                (d.el = t(
                  "tagName" in k.target ? k.target : k.target.parentNode
                )),
                a && clearTimeout(a),
                (d.x1 = k.pageX),
                (d.y1 = k.pageY),
            ...
            //   ("MSPointerUp" != e.type || s(e.originalEvent)) &&
                ...
                //             d.isDoubleTap
                //               ? (void 0 !== d.el && d.el.trigger("doubleTap"),
                //                 (d = {}))
            ...
            .on("touchcancel MSPointerCancel pointercancel", function (t) {
              (("touchcancel" == t.type && p && m) ||
                (!p && "pointercancel" == t.type && f)) &&
                o();
            }),
            ...
            if (!i.data("smoothScroll")) {
              {
                t.smoothScroll(
                  i,
                  t.Utils.options(i.attr("data-uk-smooth-scroll"))
                );
              }
              i.trigger("click");
            }
            ...
            n.each(function () {
              ...
              !l ||
                ...
                !l &&
                  ...
                  e.options.repeat &&
                  (n.data("scrollspy-idle") &&
                    (clearTimeout(n.data("scrollspy-idle")),
                    n.data("scrollspy-idle", !1)),
      ...
      checkDimensions: function () {
        if (this.dropdown.length) {
          ...
          if (
            ...
            var p;
            switch (
              this.checkBoundary(n.left + h.left, n.top + h.top, r, l, c)
            ) {
              case "x":
            ...
            p &&
              ...
              this.checkBoundary(n.left + h.left, n.top + h.top, r, l, c) &&
                ((e = u.split("-")), (h = d[u] ? d[u] : d["bottom-left"])));
          }
          r > c &&
            ...
            : (i =
                "string" == typeof i || "number" == typeof i
                  ...
                  : t
                      .$("<div></div>")
                      .html(
                        "UIkit2.modal Error: Unsupported data type: " + typeof i
                      )),
            ...
            i.on("click", 'a[href*="#"]', function () {
              ...
              "#" != e &&
                (t.$doc.one("hide.uk.offcanvas", function () {
                  ...
                  n.length ||
                    (n = t.$('[name="' + i[0].hash.replace("#", "") + '"]')),
                    n.length && t.Utils.scrollToElement
    ...
    t.component("switcher", {
      ...
      (e = {
        ...
        "slide-vertical": function (t, e) {
          ...
          return (
            t && t.index() > e.index() && n.reverse(), i.apply(this, [n, t, e])
          );
        },
